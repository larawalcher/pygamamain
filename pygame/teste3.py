...
class Janela:
    def __init__(self, resolucao=(1280, 720), titulo='CodeSnake', fps=30):
        pg.init()
        ...
        self.imagem_maca = pg.image.load("macapygame.webp")
        self.imagem_maca = pg.transform.scale(self.imagem_maca, (30, 30))
        self.imagem_cobra = pg.image.load("cobra.wepb")  # Adicionando imagem da cobra
        self.imagem_cobra = pg.transform.scale(self.imagem_cobra, (30, 30))
    ...
    def botao(self, texto, pos, tamanho, cor='branco', cor_texto='preto'):
        retangulo = pg.Rect(*pos, *tamanho)
        pg.draw.rect(self.janela, CORES[cor], retangulo)
    ...
    while janela.executando:
        ...
        if janela.menu_inicial:
            ...
            for segmento in jogo.cobrinha:
                janela.janela.blit(janela.imagem_cobra, (segmento[0] * 24, segmento[1] * 24))
